...
@Composable
fun DrawTextInstructionBlock(
    instruction: InstructionRuntime.Visuals.DrawText,
    onEditInstruction: (InstructionRuntime.Visuals.DrawText) -> Unit,
    ...
    FlowRow(
        ...
        InstructionField(
            instructionField = instruction.text,
        ...
        InstructionField(
            instructionField = instruction.fontSize,
            onValueChanged = onEditInstruction
        )
